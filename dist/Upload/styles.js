...
exports.FileInput = exports.Text = exports.Icon = exports.Label = exports.Button = void 0;
...
const Button = (0, _styledComponents.default)(_styles.ButtonBase)(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n  background-color: ", ";\n  color: ", ";\n  pointer-events: ", ";\n  &:hover {\n    background-color: ", ";\n  }\n  &:active {\n    background-color: #cbcbcb;\n  }\n  ", ";\n"])), props => props.disabled ? "#f7f7f7" : "#E5E5E5", props => props.disabled ? "#9b9b9b" : "#4A4A4A", props => props.disabled ? "none" : "auto", props => props.disabled ? "#f7f7f7 !important" : " #EFEFEF", props => _objectSpread({}, props.theme || {}));
...
const FileInput = _styledComponents.default.input(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral(["\n  display: none;\n"])));
