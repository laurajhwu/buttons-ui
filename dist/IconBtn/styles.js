...
exports.Icon = exports.Button = void 0;
...
const Button = (0, _styledComponents.default)(_styles.ButtonBase)(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n  background-color: ", ";\n  color: ", ";\n  padding: ", ";\n  border-radius: ", ";\n  pointer-events: ", ";\n  &:hover {\n    background-color: ", ";\n  }\n  &:active {\n    background-color: #cbcbcb;\n  }\n  ", ";\n"])), props => props.disabled ? "#f7f7f7" : "#EBEBEB", props => props.disabled ? "#9b9b9b" : "#4A4A4A", props => props.circle ? "16px" : "8px", props => props.circle ? "50%" : "10px", props => props.disabled ? "none" : "auto", props => props.disabled ? "#f7f7f7 !important" : "#F1F1F1", props => _objectSpread({}, props.theme || {}));
