...
const Button = (0, _styledComponents.default)(_styles.ButtonBase)(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n  background-color: ", ";\n  color: ", ";\n  pointer-events: ", ";\n  height: ", ";\n  padding: ", ";\n  width: ", ";\n  position: relative;\n  &:hover {\n    background-color: ", ";\n  }\n  &:active {\n    background-color: #2d4f57;\n  }\n  ", ";\n"])), props => props.disabled ? "#f7f7f7" : "#38636D", props => props.disabled ? "#9b9b9b" : "#B9EFE7", props => props.disabled ? "none" : "auto", props => props.size === "small" ? "32px" : "auto", props => props.size === "small" ? "6px 16px" : "10px 16px", props => props.size === "small" ? "auto" : props.size === "large" ? "300px" : "200px", props => props.disabled ? "#f7f7f7 !important" : " #719198", props => _objectSpread({}, props.theme || {}));
